#!/usr/bin/env python3
"""
Test script to verify the fix_pysd_poisson.py works correctly with .py file
"""
...
# Check for the model files
if os.path.exists("model_13.py"):
    print("📊 Loading Python model file (model_13.py)...")
    model_file = "model_13.py"
elif os.path.exists("model_13.mdl"):
    print("📊 Loading Vensim model file (model_13.mdl)...")
    model_file = "model_13.mdl"
else:
