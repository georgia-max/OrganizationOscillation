...
@component.add(
    ...
    other_deps={
        "_integ_pink_noise_structure": {
            "initial": {"mean": 1, "std_deviation": 1, "seed": 1},
            "step": {"updating_pink_noise": 1},
        }
    },
)
def pink_noise_structure():
    """
...
@component.add(
    ...
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"gap": 1, "correlation_time": 1},
)
...
@component.add(
    ...
    other_deps={
        "_macro_pink_noise_pink_noise_macro_output": {
            ...
            "step": {"mean": 1, "std_deviation": 1, "correlation_time": 1, "seed": 1},
        }
    },
)
...
_macro_pink_noise_pink_noise_macro_output = Macro(
    ...
    py_name="_macro_pink_noise_pink_noise_macro_output",
)
